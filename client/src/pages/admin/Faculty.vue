...
const message = ref(
  "Are you sure you want to delete this faculty? This action will result in the deletion of all associated departments, promotions, and students."
);
...
const handleDeleteItem = async () => {
  await deleteFaculty(selectedID.value);
};
